...
把指定區塊檔（`day2_zh/tools/chunks/<stage>/<檔名>.json`）裡的英文逐字稿翻成**台灣用語繁體中文**，寫成同名 `.md`，放到 `day2_zh/tools/zh_chunks/<stage>/<檔名>.md`（目錄不存在請建立）。
...
- 不要修改 `chunks/`、`segments/`、`cleaned/`、`agenda.json`、`day2/` 或任何既有檔案
